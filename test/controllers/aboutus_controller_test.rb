...
class AboutusControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aboutu" do
    assert_difference('Aboutu.count') do
      post aboutus_url, params: { aboutu: { body: @aboutu.body, heading1: @aboutu.heading1, title: @aboutu.title } }
    end
  ...
  test "should update aboutu" do
    patch aboutu_url(@aboutu), params: { aboutu: { body: @aboutu.body, heading1: @aboutu.heading1, title: @aboutu.title } }
