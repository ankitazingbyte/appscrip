...
class SocialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post socials_url, params: { social: { description: @social.description, image: @social.image, title: @social.title } }
    end
  ...
  test "should update social" do
    patch social_url(@social), params: { social: { description: @social.description, image: @social.image, title: @social.title } }
