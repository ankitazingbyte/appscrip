...
class LandingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landing" do
    assert_difference('Landing.count') do
      post landings_url, params: { landing: { body: @landing.body, heading: @landing.heading, image: @landing.image, title: @landing.title } }
    end
  ...
  test "should update landing" do
    patch landing_url(@landing), params: { landing: { body: @landing.body, heading: @landing.heading, image: @landing.image, title: @landing.title } }
