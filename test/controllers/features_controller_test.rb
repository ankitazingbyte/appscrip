...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { image: @feature.image, titile: @feature.titile } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { image: @feature.image, titile: @feature.titile } }
