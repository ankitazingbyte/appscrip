...
class DemandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demand" do
    assert_difference('Demand.count') do
      post demands_url, params: { demand: { description: @demand.description, image: @demand.image, title: @demand.title } }
    end
  ...
  test "should update demand" do
    patch demand_url(@demand), params: { demand: { description: @demand.description, image: @demand.image, title: @demand.title } }
