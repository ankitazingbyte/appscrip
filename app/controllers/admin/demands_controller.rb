class Admin::DemandsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @demand.save
        format.html { redirect_to admin_demand_url(@demand), notice: 'Demand was successfully created.' }
  ...
  private
    ...
    def demand_params
      params.require(:demand).permit(:title, :description, :image)
    end
end
