class Admin::SocialsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @social.save
        format.html { redirect_to admin_social_url(@social), notice: 'Social was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @social.update(social_params)
        format.html { redirect_to admin_social_url(@social), notice: 'Social was successfully updated.' }
  ...
  def destroy
    @social.destroy
    respond_to do |format|
      format.html { redirect_to admin_socials_url, notice: 'Social was successfully destroyed.' }
  ...
  private
    ...
    def social_params
      params.require(:social).permit(:title, :description, :image)
    end
end
