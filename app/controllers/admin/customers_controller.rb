class Admin::CustomersController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @customer.save
        format.html { redirect_to admin_customer_url(@customer), notice: 'Customer was successfully created.' }
  ...
  private
    ...
    def customer_params
      params.require(:customer).permit(:name, :designation, :message, :image)
    end
end
