class Admin::AboutusController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @aboutu.save
        format.html { redirect_to admin_aboutu_url(@aboutu), notice: 'Aboutu was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @aboutu.update(aboutu_params)
        format.html { redirect_to admin_aboutu_url(@aboutu), notice: 'Aboutu was successfully updated.' }
  ...
  def destroy
    @aboutu.destroy
    respond_to do |format|
      format.html { redirect_to admin_aboutus_url, notice: 'Aboutu was successfully destroyed.' }
  ...
  private
    ...
    def aboutu_params
      params.require(:aboutu).permit(:title, :heading1, :body)
    end
end
