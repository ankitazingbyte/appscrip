class Admin::LandingsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @landing.save
        format.html { redirect_to admin_landing_url(@landing), notice: 'Landing was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @landing.update(landing_params)
        format.html { redirect_to admin_landing_url(@landing), notice: 'Landing was successfully updated.' }
  ...
  def destroy
    @landing.destroy
    respond_to do |format|
      format.html { redirect_to admin_landings_url, notice: 'Landing was successfully destroyed.' }
  ...
  private
    ...
    def landing_params
      params.require(:landing).permit(:title, :image, :heading, :body)
    end
end
