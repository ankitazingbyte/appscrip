class Admin::FaqsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @faq.save
        format.html { redirect_to admin_faq_url(@faq), notice: 'Faq was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @faq.update(faq_params)
        format.html { redirect_to admin_faq_url(@faq), notice: 'Faq was successfully updated.' }
